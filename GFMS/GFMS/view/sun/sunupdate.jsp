...
<html>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <center> <br>
    <form id="add" name="add" action="<%=path%>/sunUpdate.do" method="post">
         ...
         <%
    		...
    		<input type="hidden" id="id" name="id" value="<bean:write name="SUN" property="id" scope="request"/>">
           <input type="hidden" id="timeid" name="timeid" value="<bean:write name="SUN" property="timeid" scope="request"/>">
    		...
    		<tr>
    	      <td   class="listcellrow">  
    		   ...
    		   <td  class="listcellrow">
    		   <input type="text" id="fssj" name="fssj" size="16" value='<bean:write name="SUN" property="fssj" scope="request"  format="yyyy-MM-dd HH:mm"/>' class="text"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})">
    		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    		...
    		<tr>
    	      <td   class="listcellrow">  
    		   ...
    		   <td  class="listcellrow">
    		   <input type="text" id="clsj" name="clsj" size="16" value='<bean:write name="SUN" property="clsj" scope="request"  format="yyyy-MM-dd HH:mm"/>' class="text"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"><br>
    		...
    		<tr>
              <td  Width="100" class="listcellrow">
    		   ...
    		   <td  class="listcellrow">
    		    <input type="text" id="fxr" name="fxr" value="<bean:write name="SUN" property="fxr" scope="request"/>" class="text"> &nbsp;&nbsp;&nbsp;&nbsp;
    		...
    		<tr>
              <td  Width="100" class="listcellrow"> 
    		  验收人  </td>
    		   <td  class="listcellrow"><input type="text" id="ysr" name="ysr" value="<bean:write name="SUN" property="ysr" scope="request"/>" class="text">
    		 ...
    		 <tr>
    	      ...
    	      <td   class="listcellrow">  
    		   ...
    		   <td  class="listcellrow">
    		   <input type="text" id="tbr" name="tbr" value="<bean:write name="SUN" property="tbr" scope="request"/>" class="text" readonly>&nbsp;&nbsp;&nbsp;&nbsp;
    		      		   <input type="hidden" id="jhzt" name="jhzt" value="<bean:write name="SUN" property="jhzt" scope="request"/>">     
    		   </td>
    		   </tr>
