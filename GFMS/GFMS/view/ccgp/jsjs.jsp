         ...
         <%
    		...
    		<tr  class="listtitle">
    		 ...
    		 <tr>
              <td  class="listcellrow">
    		   ...
    		   <td  class="listcellrow">
    		    <input type="text" id="zqmc" name="zqmc" value=""  class="text"><br>
    	   ...
    	   <tr>
              <td  class="listcellrow">
    		   ...
    		   <td  class="listcellrow">
    		    <input type="text" id="numb" name="numb" value=""  class="text"><br>
    	    ...
    	    <tr>
              <td  class="listcellrow">
    		   ...
    		   <td  class="listcellrow">
    		    <input type="text" id="cbj" name="cbj" value=""   class="text"><br>
    	   ...
    	   <tr>
              <td  class="listcellrow">
    		   ...
    		   <td  class="listcellrow">
    		    <input type="text" id="dqj" name="dqj" value=""  class="text" onchange="getChange();" >
    		    &nbsp;最低回本价:
